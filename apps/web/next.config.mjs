...
const nextConfig = {
  ...
  // output: 'standalone',
  //
  // assetPrefix: empty by default (no reverse proxy in front of the
  // Next.js server). If you front it with a path-prefixing reverse
  // proxy, set HA_INGRESS_ASSET_PREFIX at BUILD time (the value is
  // baked into HTML/JS asset URLs). This was previously used by the
  // HA add-on ingress path; desktop mode doesn't need it.
